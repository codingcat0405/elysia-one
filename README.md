...
- `apps/client`: a [TanStack Start](https://tanstack.com/start) + React app — Better Auth (username/password + optional Google OAuth, bearer token auth), Zustand for global user state, Eden Treaty typed API client. See `apps/client/README.md` / `apps/client/AGENTS.md`.
